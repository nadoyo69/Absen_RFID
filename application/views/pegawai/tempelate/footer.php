...
<footer class="footer text-center">
    ...
    </script> By <a style="color:black" href="<?= base_url() ?>" target="_blank">NADOYO</a>
</footer>
...
<script src="<?= base_url() ?>assets/admin/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
